...
INSERT INTO `gym` VALUES (1,'Iron Gym','New Delhi','123456789'),(2,'Pulse Fitness','New Delhi','987654321'),(101,'Testing gym','Test','987654321'),(102,'Fitness World','123 Main St','555111234'),(103,'fit','gurgaon','12345673223');
...
CREATE TABLE `gym_admin` (
  ...
  KEY `gym_id` (`gym_id`),
  CONSTRAINT `fk_gym_admin_user` FOREIGN KEY (`user_id`) REFERENCES `authing`.`users_auth` (`user_id`),
...
CREATE TABLE `member` (
  ...
  CONSTRAINT `fk_member_user` FOREIGN KEY (`user_id`) REFERENCES `authing`.`users_auth` (`user_id`),
...
CREATE TABLE `trainer` (
  ...
  UNIQUE KEY `user_id` (`user_id`),
  KEY `gym_id` (`gym_id`),
  CONSTRAINT `fk_trainer_user` FOREIGN KEY (`user_id`) REFERENCES `authing`.`users_auth` (`user_id`),
...
-- Dump completed on 2026-03-13  3:30:39
